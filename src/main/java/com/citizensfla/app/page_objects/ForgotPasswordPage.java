...
public class ForgotPasswordPage {
	...
	public ForgotPasswordPage(WebDriver driver) {
		this.driver = driver;
		this.wait = new WebDriverWait(driver, Duration.ofSeconds(10)); // Use explicit wait to avoid stale element
																		// issues
	}
	...
	public void verifyPageHeader() {
		...
		assert header.getText().contains("Forgot Username/Password");
	}
}
